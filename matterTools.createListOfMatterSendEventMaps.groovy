...
@Field static Map globalAllEventsMap = [ // Map of clusterInt provides Map of attributeInt provides List of one or more Maps of events
    ...
    0x0008:[ // Level Cluster
        ...
        0x000F:[[attribute:"Options",          		units:"bitmap"  	]],
    ...
    0x0045:[ // Generic Switch Cluster
        0x0000:[[attribute:"NumberOfPositions",    		]], // Number of Plsitions
        0x0001:[[attribute:"CurrentPosition",      		]], // Current Position
        0x0002:[[attribute:"MultiPressMax",        		]], // Multi-Press Max
        ],
    0x0300:[ // Color Control Cluster.  Only covering the most common ones for Hue at the moment!
        ...
        0x0007:[[attribute:"colorTemperature",          valueTransform: this.&MiredsToKelvin,    unit: "°K"], 
                [attribute:"ColorTemperatureMireds",    unit: "Mireds"],
               ],
    ...
    0x040C: [
        ...
        0x0004:[[attribute:"PeakMeasuredValueWindow",        unit:"seconds" ]],
