...
void parse(String description) {
    try {
        Map decodedDescMap = parseDescriptionAsDecodedMap(description) // Using my custom parser!
        if (logEnable) log.info "From read attribute description string:<br>${description}<br>got decoded Map:${decodedDescMap}"
